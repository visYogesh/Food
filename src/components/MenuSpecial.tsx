    ...
    >
      ...
      <section className="pt-28 md:pt-32 pb-12">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-6xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-orange-400 via-yellow-500 to-amber-500 animate-typing-regular1">
              Halal Menu
            </h2>
          ...
          <p className="text-base sm:text-lg leading-relaxed mb-12 text-gray-50">
            Our entire menu is prepared under Halal standards, ensuring quality, authenticity, and respect for every palate.
          </p>
